...
namespace Unity.XR.XREAL.Samples
{
    ...
    #endif
    public class XREALGameCapture : Common.SingleTon.SingletonMonoBehaviour<XREALGameCapture>
    {
        ...
        [SerializeField] private InputActionProperty m_openAction;
        ...
        new void Awake()
        {
            ...
            m_openAction.action.performed += OpenCaptureWindow;
            m_VideoButton.onClick.AddListener(RecordVideo);
            m_PhotoButton.onClick.AddListener(TakeAPhoto);
            m_ReturnButton.onClick.AddListener(() => SwitchActiveCaptureView(false));
        ...
        public void StartVideoCapture()
        {
            ...
            cameraParameters.cameraType = Unity.XR.XREAL.CameraType.RGB;
        ...
        public void OpenCaptureWindow(InputAction.CallbackContext context)
        {
            Debug.Log("キャプチャ画面");
            if (!(context.interaction is HoldInteraction)) return;

            Debug.Log("ON");
            SwitchActiveCaptureView(!m_root.activeSelf);
        }

        public void SwitchActiveCaptureView(bool active)
        {
